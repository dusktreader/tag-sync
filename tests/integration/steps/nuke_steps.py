...
def run_nuke_force_dry_run(bdd_context: dict, run_tag_sync) -> None:
    bdd_context["result"] = run_tag_sync("nuke", "--force", "--dry-run", "v1.2.3")
